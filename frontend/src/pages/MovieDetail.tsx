  ...
  return (
    <div className="flex flex-col min-h-screen overflow-hidden">
      <section className="relative flex items-center justify-center h-[70vh] sm:h-[80vh]">
        ...
        <div className="relative z-30 flex flex-col items-center cursor-pointer group">
          <PlayCircleIcon className="w-20 h-20 transition-opacity duration-300 ease-in-out opacity-80 group-hover:scale-110 group-hover:opacity-100" />
          <p className="mt-2 text-sm text-gray-300 transition-opacity duration-300 opacity-0 group-hover:text-white group-hover:opacity-100">
            予告編を見る
          </p>
        </div>
