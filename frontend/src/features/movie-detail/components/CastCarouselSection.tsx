        ...
        {cast.map((actor, idx) => (
          ...
          >
            ...
            <div className="text-center">
              <p className="font-body text-xs md:text-sm font-bold text-on-surface truncate w-20 md:w-24 group-hover:text-primary transition-colors">
                {actor.name}
              </p>
              <p className="font-label text-[10px] md:text-xs text-on-surface-variant uppercase tracking-tighter truncate w-20 md:w-24 mt-0.5">
                {actor.character}
              </p>
            </div>
          </Link>
